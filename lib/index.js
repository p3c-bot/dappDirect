        ...
        columns: [{
          ...
          },
          {
            ...
            render: function (data, type, row) {
              ...
              return numberWithCommas(digest[row.contract.toLowerCase()].txs)
            }
          },
          {
            data: 'dapp',
          ...
          },
          {
            ...
            render: function (data, type, row) {
              ...
              return numberWithCommas(parseInt(balance[row.contract.toLowerCase()]))
            }
          },
          {
            data: 'category'
          ...
          },
          {
            ...
            render: function (data, type, row) {
              ...
              return numberWithCommas(digest[row.contract.toLowerCase()].volume.toFixed(2))
            }
          },
          {
            data: 'contact',
